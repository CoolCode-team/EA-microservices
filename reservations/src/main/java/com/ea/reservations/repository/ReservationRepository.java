package com.ea.reservations.repository;
...
public interface ReservationRepository extends JpaRepository<Reservation, UUID> {
    ...
    @Query(
            "SELECT r FROM reservations r WHERE r.academicSpaceId = :academicSpaceId AND " +
    ...
    Optional<Reservation> findReservationByIdAndUserId(String id, UUID userId);
